...
import 'package:movie_moves/widgets/bookcover.dart';
import 'package:movie_moves/widgets/bookpagebook.dart';
import 'package:movie_moves/widgets/bookpagescrolleffects.dart';
...
class _Header extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const moviePoster = Padding(              //movie poster properties
      padding: EdgeInsets.all(6.0),
      child: EventPoster(
        // event: event,
        size: Size(125.0, 187.5),
...
class _BackButton extends StatelessWidget {             //back button properties
  const _BackButton(this.scrollEffects);
...
class _EventInfo extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final content = <Widget>[..._buildTitleAndLengthInMinutes()];
...
class _DirectorInfo extends StatefulWidget {     //director details
  const _DirectorInfo(this.director);
  final String director;

  @override
  State<_DirectorInfo> createState() => _DirectorInfoState();
}

class _DirectorInfoState extends State<_DirectorInfo> {
  @override
  Widget build(BuildContext context) {
